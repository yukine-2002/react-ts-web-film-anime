        ...
        <div className="video-container">
          ...
          <div className="intro">
            <div className="title m-top-50 m-bottom-50">
              <h3>{source?.film_name || info?.name} - {source?.full_name }</h3>
            </div>
            ...
            <div className="intro-content">
              ...
              <div className="intro-genres">
                {
                  info?.genres.map(item => <div key={item.slug} className="intro-genres-collection" >
                                  <span style={{background : `${randomColor()}`}}>{item.name}</span>
                                </div> )
                }
              </div>
              <h4>Team Sub :</h4>
